...
<html lang="en">
    <head>
        ...
        <title>Login - Página do integrante</title>
    </head>
    <body class="pt-5" style="background-image: url(<?= base_url('assets/images/bkg-login2.png')?>);">
        <div class="px-3">
            <div class="mt-sm-5 mt-md-5 mt-lg-5 mt-xl-5 col-sm-6 col-md-6 col-lg-4 col-xl-4 p-3 mx-auto rounded shadow" style="background-color: rgb(255, 255, 255, 1);">
                <form method="POST" action="<?=base_url("index.php/dashboard/logar")?>">
                    <div class="form-group">
                        <label for="">Usuário</label>
                        <input type="text" name="user_login" class="form-control" placeholder="Digite o usuário">
                    </div>
                    
                    <div class="form-group">
                        <label for="">Senha</label>
                        <input type="password" name="senha_login" class="form-control"  placeholder="Digite a senha">
                    </div>

                    <div class="d-flex justify-content-end">
                        <a href="<?=base_url("index.php/home/")?>" class="btn btn-secondary">Voltar</a>
                        <button type="submit" class="btn btn-add ml-3">Entrar</button>
                    </div>
                </form>
            </div>
        </div>
